...
(def special-formbar-types [:temp :temp :temp])
(def settings-special-forms-text-y -0.7)
(def settings-special-forms-y -0.45)
(def settings-special-forms-radius 0.125)
(def settings-special-forms-spacing 1.1)
(def settings-special-forms-text-size 0.7)
(def settings-saved-formbars-text-y -0.2)
(def settings-saved-formbars-text-size 0.7)
(def settings-saved-formbars-box-y -0.1)
(def settings-saved-formbars-box-width 0.65)
(def settings-saved-formbars-box-height 0.8)
